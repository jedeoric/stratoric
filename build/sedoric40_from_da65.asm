...
LC421:  inc     BASIC11_HIMEM_MAX_ADRESS        ; C421 EE C1 02                 ...
        ...
        ldx     #$00                            ; C427 A2 00                    ..
LC429:  lda     LC600,x                         ; C429 BD 00 C6                 ...
...
; ----------------------------------------------------------------------------
        .byte   $0D                             ; C5FF 0D                       .
LC600:  cmp     #$30                            ; C600 C9 30                    .0
        bcc     LC608                           ; C602 90 04                    ..
        cmp     #$3A                            ; C604 C9 3A                    .:
        bcc     LC63D                           ; C606 90 35                    .5
LC608:  stx     $0F                             ; C608 86 0F                    ..
        tax                                     ; C60A AA                       .
        bmi     LC63B                           ; C60B 30 2E                    0.
        sta     $C1                             ; C60D 85 C1                    ..
        pla                                     ; C60F 68                       h
        tax                                     ; C610 AA                       .
        pla                                     ; C611 68                       h
        pha                                     ; C612 48                       H
        cpx     #$F7                            ; C613 E0 F7                    ..
        bne     LC61B                           ; C615 D0 04                    ..
        cmp     #$C8                            ; C617 C9 C8                    ..
        beq     LC624                           ; C619 F0 09                    ..
LC61B:  cpx     #$58                            ; C61B E0 58                    .X
        bne     LC637                           ; C61D D0 18                    ..
        cmp     #$CA                            ; C61F C9 CA                    ..
        bne     LC637                           ; C621 D0 14                    ..
        .byte   $24                             ; C623 24                       $
LC624:  clc                                     ; C624 18                       .
        ror     SEDORIC_FLAGIF                  ; C625 6E FC 04                 n..
        ldy     #$FF                            ; C628 A0 FF                    ..
LC62A:  iny                                     ; C62A C8                       .
        lda     ($E9),y                         ; C62B B1 E9                    ..
        beq     LC640                           ; C62D F0 11                    ..
        cmp     #$3A                            ; C62F C9 3A                    .:
        beq     LC640                           ; C631 F0 0D                    ..
        cmp     #$D4                            ; C633 C9 D4                    ..
        bne     LC62A                           ; C635 D0 F3                    ..
LC637:  txa                                     ; C637 8A                       .
        pha                                     ; C638 48                       H
        lda     $C1                             ; C639 A5 C1                    ..
LC63B:  ldx     $0F                             ; C63B A6 0F                    ..
LC63D:  jmp     LEA41                           ; C63D 4C 41 EA                 LA.

; ----------------------------------------------------------------------------
LC640:  pla                                     ; C640 68                       h
        jsr     L04E9                           ; C641 20 E9 04                  ..
LC644:  jsr     L0467                           ; C644 20 67 04                  g.
        asl     SEDORIC_FLAGIF                  ; C647 0E FC 04                 ...
        bcs     LC64F                           ; C64A B0 03                    ..
        jmp     LC8AD                           ; C64C 4C AD C8                 L..
...
; ----------------------------------------------------------------------------
        jsr     DO_RAMROM                       ; C653 20 77 04                  w.
        lda     ($16),y                         ; C656 B1 16                    ..
        jmp     DO_RAMROM                       ; C658 4C 77 04                 Lw.
...
; ----------------------------------------------------------------------------
        ...
        lda     #$8E                            ; C661 A9 8E                    ..
        ldy     #$F8                            ; C663 A0 F8                    ..
        bne     LC66B                           ; C665 D0 04                    ..
        lda     #$AE                            ; C667 A9 AE                    ..
        ldy     #$D3                            ; C669 A0 D3                    ..
LC66B:  sta     SEDORIC_EXEVEC+1                ; C66B 8D F0 04                 ...
        sty     SEDORIC_EXEVEC+2                ; C66E 8C F1 04                 ...
        jsr     DO_RAMROM                       ; C671 20 77 04                  w.
        jsr     SEDORIC_EXEVEC                  ; C674 20 EF 04                  ..
        php                                     ; C677 08                       .
        pha                                     ; C678 48                       H
        sei                                     ; C679 78                       x
        lda     MICRODISC_CONTROL_SHADOW        ; C67A AD FB 04                 ...
        eor     #$02                            ; C67D 49 02                    I.
        sta     MICRODISC_CONTROL_SHADOW        ; C67F 8D FB 04                 ...
        sta     MICRODISC_CONTROL               ; C682 8D 14 03                 ...
        pla                                     ; C685 68                       h
        plp                                     ; C686 28                       (
        rts                                     ; C687 60                       `

; ----------------------------------------------------------------------------
        bit     V1IFR                           ; C688 2C 0D 03                 ,..
        bvc     LC69C                           ; C68B 50 0F                    P.
        pha                                     ; C68D 48                       H
        lda     #$04                            ; C68E A9 04                    ..
        and     BASIC11_FLG                     ; C690 2D 6A 02                 -j.
        beq     LC698                           ; C693 F0 03                    ..
        inc     BASIC11_BLINK_CURSOR            ; C695 EE 74 02                 .t.
LC698:  pla                                     ; C698 68                       h
        jmp     LEC03                           ; C699 4C 03 EC                 L..

; ----------------------------------------------------------------------------
LC69C:  pla                                     ; C69C 68                       h
        pla                                     ; C69D 68                       h
        sta     SEDORIC_TRAV0                   ; C69E 85 F2                    ..
        pla                                     ; C6A0 68                       h
        tax                                     ; C6A1 AA                       .
        lda     #$36                            ; C6A2 A9 36                    .6
        ldy     #$D1                            ; C6A4 A0 D1                    ..
        bne     LC66B                           ; C6A6 D0 C3                    ..
        jsr     RAMROM                          ; C6A8 20 F2 04                  ..
        pla                                     ; C6AB 68                       h
        rti                                     ; C6AC 40                       @

; ----------------------------------------------------------------------------
        sta     MICRODISC_CONTROL               ; C6AD 8D 14 03                 ...
        jmp     (RESET_VECTOR)                  ; C6B0 6C FC FF                 l..

; ----------------------------------------------------------------------------
        clc                                     ; C6B3 18                       .
        jsr     DO_RAMROM                       ; C6B4 20 77 04                  w.
        pha                                     ; C6B7 48                       H
        lda     #$04                            ; C6B8 A9 04                    ..
        pha                                     ; C6BA 48                       H
        lda     #$A8                            ; C6BB A9 A8                    ..
        pha                                     ; C6BD 48                       H
        php                                     ; C6BE 08                       .
        bcs     LC6C4                           ; C6BF B0 03                    ..
        jmp     L0228                           ; C6C1 4C 28 02                 L(.

; ----------------------------------------------------------------------------
LC6C4:  jsr     LF888                           ; C6C4 20 88 F8                  ..
        lda     #$17                            ; C6C7 A9 17                    ..
        ldy     #$EC                            ; C6C9 A0 EC                    ..
        jsr     L046B                           ; C6CB 20 6B 04                  k.
        jmp     LC475                           ; C6CE 4C 75 C4                 Lu.
...
; ----------------------------------------------------------------------------
        ...
        tya                                     ; C6D9 98                       .
        pha                                     ; C6DA 48                       H
        jsr     RAMROM                          ; C6DB 20 F2 04                  ..
        jmp     LD270                           ; C6DE 4C 70 D2                 Lp.
...
; ----------------------------------------------------------------------------
        ...
        nop                                     ; C6E7 EA                       .
        nop                                     ; C6E8 EA                       .
        jmp     L0487                           ; C6E9 4C 87 04                 L..

; ----------------------------------------------------------------------------
        jmp     L0471                           ; C6EC 4C 71 04                 Lq.

; ----------------------------------------------------------------------------
        jmp     L0000                           ; C6EF 4C 00 00                 L..

; ----------------------------------------------------------------------------
        jmp     DO_RAMROM                       ; C6F2 4C 77 04                 Lw.

; ----------------------------------------------------------------------------
        jmp     DO_IRQRAM                       ; C6F5 4C B3 04                 L..

; ----------------------------------------------------------------------------
        jmp     L04B4                           ; C6F8 4C B4 04                 L..

; ----------------------------------------------------------------------------
        sty     L0000                           ; C6FB 84 00                    ..
        brk                                     ; C6FD 00                       .
        brk                                     ; C6FE 00                       .
        brk                                     ; C6FF 00                       .
; Page4, Atmos
...
REDEF:  .byte   $20,$20,$20,$20,$20,$20,$20,$20 ; C880 20 20 20 20 20 20 20 20          
        ...
        .byte   $46,$35,$2C,$23,$34             ; C8A8 46 35 2C 23 34           F5,#4
LC8AD:  .byte   $36,$37,$8D,$20,$20,$20,$20,$20 ; C8AD 36 37 8D 20 20 20 20 20  67.     
        .byte   $20,$44,$4F,$4B,$45,$23,$32,$46 ; C8B5 20 44 4F 4B 45 23 32 46   DOKE#2F
        .byte   $39,$2C,$A3,$20,$44,$4F,$4B,$45 ; C8BD 39 2C A3 20 44 4F 4B 45  9,. DOKE
        .byte   $23,$32,$46,$39,$2C,$23,$44,$30 ; C8C5 23 32 46 39 2C 23 44 30  #2F9,#D0
        .byte   $37,$30,$8D,$20,$20,$20,$20,$20 ; C8CD 37 30 8D 20 20 20 20 20  70.     
        .byte   $20,$44,$4F,$4B,$45,$23,$32,$46 ; C8D5 20 44 4F 4B 45 23 32 46   DOKE#2F
        .byte   $43,$2C,$A3,$20,$20,$44,$4F,$4B ; C8DD 43 2C A3 20 20 44 4F 4B  C,.  DOK
        .byte   $45,$23,$32,$46,$43,$2C,$23,$34 ; C8E5 45 23 32 46 43 2C 23 34  E#2FC,#4
        .byte   $36,$31,$8D,$20,$20,$20,$20,$50 ; C8ED 36 31 8D 20 20 20 20 50  61.    P
        .byte   $41,$50,$45,$52,$30,$3A,$49,$4E ; C8F5 41 50 45 52 30 3A 49 4E  APER0:IN
        .byte   $4B,$37,$8D,$20,$20,$20,$20,$20 ; C8FD 4B 37 8D 20 20 20 20 20  K7.     
        .byte   $20,$43,$41,$4C,$4C,$23,$46,$38 ; C905 20 43 41 4C 4C 23 46 38   CALL#F8
        .byte   $44,$30,$8D,$20,$20,$20,$20,$20 ; C90D 44 30 8D 20 20 20 20 20  D0.     
        .byte   $20,$20,$20,$20,$20,$20,$20,$20 ; C915 20 20 20 20 20 20 20 20          
        .byte   $20,$20,$FE,$20,$20,$20,$20,$3F ; C91D 20 20 FE 20 20 20 20 3F    .    ?
        .byte   $48,$45,$58,$24,$28,$50,$45,$45 ; C925 48 45 58 24 28 50 45 45  HEX$(PEE
        .byte   $4B,$28,$A3,$20,$20,$20,$20,$3F ; C92D 4B 28 A3 20 20 20 20 3F  K(.    ?
        .byte   $48,$45,$58,$24,$28,$44,$45,$45 ; C935 48 45 58 24 28 44 45 45  HEX$(DEE
        .byte   $4B,$28,$A3,$20,$20,$20,$20,$20 ; C93D 4B 28 A3 20 20 20 20 20  K(.     
        .byte   $20,$20,$20,$20,$20,$50,$45,$45 ; C945 20 20 20 20 20 50 45 45       PEE
        .byte   $4B,$28,$A3,$20,$20,$20,$20,$20 ; C94D 4B 28 A3 20 20 20 20 20  K(.     
        .byte   $20,$20,$20,$20,$20,$44,$45,$45 ; C955 20 20 20 20 20 44 45 45       DEE
        .byte   $4B,$28,$A3,$20,$20,$20,$20,$20 ; C95D 4B 28 A3 20 20 20 20 20  K(.     
        .byte   $20,$20,$20,$20,$20,$20,$50,$4F ; C965 20 20 20 20 20 20 50 4F        PO
        .byte   $4B,$45,$A3,$20,$20,$20,$20,$20 ; C96D 4B 45 A3 20 20 20 20 20  KE.     
        .byte   $20,$20,$20,$20,$20,$20,$44,$4F ; C975 20 20 20 20 20 20 44 4F        DO
        .byte   $4B,$45,$A3                     ; C97D 4B 45 A3                 KE.
; Key shortcut table
...
LCBBE:  .byte   $03,$EE,$C9,$03,$03,$FC,$C9,$06 ; CBBE 03 EE C9 03 03 FC C9 06  ........
        ...
        .byte   $03                             ; CC26 03                       .
; ----------------------------------------------------------------------------
LCC27:  .byte   $06                             ; CC27 06                       .
LCC28:  inc     $EBDD,x                         ; CC28 FE DD EB                 ...
        bcc     $CC18                           ; CC2B 90 EB                    ..
        cmp     $50F0,x                         ; CC2D DD F0 50                 ..P
        sbc     ($DF),y                         ; CC30 F1 DF                    ..
        inc     LE772,x                         ; CC32 FE 72 E7                 .r.
        .byte   $47                             ; CC35 47                       G
        sbc     ($8C),y                         ; CC36 F1 8C                    ..
        .byte   $FB                             ; CC38 FB                       .
        lsr     BASIC11_INTERPRETER_VECTOR+1,x  ; CC39 56 F1                    V.
        jmp     LBBDE                           ; CC3B 4C DE BB                 L..

; ----------------------------------------------------------------------------
        sbc     LE9FE,y                         ; CC3E F9 FE E9                 ...
        adc     $E7,x                           ; CC41 75 E7                    u.
        eor     (BASIC11_INTERPRETER_VECTOR+1,x); CC43 41 F1                    A.
        .byte   $43                             ; CC45 43                       C
        cpx     $36                             ; CC46 E4 36                    .6
        cpx     $45                             ; CC48 E4 45                    .E
        cpx     $43                             ; CC4A E4 43                    .C
        ...
        sbc     #$7E                            ; CC5E E9 7E                    .~
        sbc     #$DF                            ; CC60 E9 DF                    ..
        cmp     LE9EC,x                         ; CC62 DD EC E9                 ...
        ldx     $9BFB,y                         ; CC65 BE FB 9B                 ...
        sbc     LEBF4,y                         ; CC68 F9 F4 EB                 ...
        pla                                     ; CC6B 68                       h
        sbc     ($2D),y                         ; CC6C F1 2D                    .-
        cpx     LF12C                           ; CC6E EC 2C F1                 .,.
        ora     ($FE),y                         ; CC71 11 FE                    ..
        .byte   $1F                             ; CC73 1F                       .
        .byte   $DA                             ; CC74 DA                       .
        .byte   $1F                             ; CC75 1F                       .
        ...
        .byte   $42                             ; CC7B 42                       B
        .byte   $E7                             ; CC7C E7                       .
        cpy     $0ADD                           ; CC7D CC DD 0A                 ...
        .byte   $E7                             ; CC80 E7                       .
        sei                                     ; CC81 78                       x
        beq     LCCF6                           ; CC82 F0 72                    .r
        .byte   $FC                             ; CC84 FC                       .
        and     BASIC11_INTERPRETER_VECTOR,x    ; CC85 35 F0                    5.
        and     BASIC11_INTERPRETER_VECTOR,x    ; CC87 35 F0                    5.
        .byte   $93                             ; CC89 93                       .
        cpx     LDFF6                           ; CC8A EC F6 DF                 ...
        lsr     $94E7                           ; CC8D 4E E7 94                 N..
; common names and extentions
DUNNO:  .byte   $FE,$EB,$EB,$6F,$E7,$35,$F1,$3B ; CC90 FE EB EB 6F E7 35 F1 3B  ...o.5.;
        .byte   $F1,$48,$E7,$1E,$E7,$AE,$E0,$4F ; CC98 F1 48 E7 1E E7 AE E0 4F  .H.....O
; ----------------------------------------------------------------------------
        .byte   $FA                             ; CCA0 FA                       .
        sei                                     ; CCA1 78                       x
        .byte   $E7                             ; CCA2 E7                       .
        dex                                     ; CCA3 CA                       .
        sbc     LE9F5,y                         ; CCA4 F9 F5 E9                 ...
        .byte   $BF                             ; CCA7 BF                       .
        .byte   $E7                             ; CCA8 E7                       .
        .byte   $8F                             ; CCA9 8F                       .
        sbc     LE7F4,y                         ; CCAA F9 F4 E7                 ...
        cpx     #$EB                            ; CCAD E0 EB                    ..
        tsx                                     ; CCAF BA                       .
        sbc     #$74                            ; CCB0 E9 74                    .t
        .byte   $FC                             ; CCB2 FC                       .
        ...
        sbc     #$F2                            ; CCC8 E9 F2                    ..
        sbc     #$4C                            ; CCCA E9 4C                    .L
        cmp     LDD49,x                         ; CCCC DD 49 DD                 .I.
        .byte   $52                             ; CCCF 52                       R
        cmp     LDD4F,x                         ; CCD0 DD 4F DD                 .O.
        .byte   $FB                             ; CCD3 FB                       .
        sbc     $59                             ; CCD4 E5 59                    .Y
        sbc     ($95),y                         ; CCD6 F1 95                    ..
        .byte   $F9                             ; CCD8 F9                       .
LCCD9:  .byte   $9C                             ; CCD9 9C                       .
        inx                                     ; CCDA E8                       .
        dec     $97F8,x                         ; CCDB DE F8 97                 ...
        inc     LF12F,x                         ; CCDE FE 2F F1                 ./.
        ror     LE0EA,x                         ; CCE1 7E EA E0                 ~..
        inx                                     ; CCE4 E8                       .
        tya                                     ; CCE5 98                       .
        inc     LE9F8                           ; CCE6 EE F8 E9                 ...
        .byte   $EF                             ; CCE9 EF                       .
        sbc     #$20                            ; CCEA E9 20                    . 
        sbc     ($45),y                         ; CCEC F1 45                    .E
        .byte   $E7                             ; CCEE E7                       .
        .byte   $0F                             ; CCEF 0F                       .
        .byte   $F2                             ; CCF0 F2                       .
        cld                                     ; CCF1 D8                       .
...
; adresse ROM 1.0 adresse ROM 1.1
Garbage9:
        .byte   $20,$D8                         ; D1C4 20 D8                     .
LD1C6:  .byte   $D5                             ; D1C6 D5                       .
; ----------------------------------------------------------------------------
...
LD417:  txa                                     ; D417 8A                       .
        asl     a                               ; D418 0A                       .
        tax                                     ; D419 AA                       .
        lda     LCC28,x                         ; D41A BD 28 CC                 .(.
        pha                                     ; D41D 48                       H
        lda     LCC27,x                         ; D41E BD 27 CC                 .'.
        pha                                     ; D421 48                       H
...
CMD_KEYSAVE:
        ...
        lda     #$DD                            ; DDDA A9 DD                    ..
        ldy     #$C9                            ; DDDC A0 C9                    ..
        bne     FIXME_BUG____________________   ; DDDE D0 1E                    ..
CMD_ESAVE:
...
LE322:  jsr     LDAB4                           ; E322 20 B4 DA                  ..
        ...
        lda     #$50                            ; E33F A9 50                    .P
LE341:  jmp     XAFCAR                          ; E341 4C 2A D6                 L*.
...
CMD_WIDTH:
        ldy     #$03                            ; E740 A0 03                    ..
        bit     $06A0                           ; E742 2C A0 06                 ,..
        bit     $09A0                           ; E745 2C A0 09                 ,..
        bit     $0CA0                           ; E748 2C A0 0C                 ,..
        bit     $0FA0                           ; E74B 2C A0 0F                 ,..
        bit     $12A0                           ; E74E 2C A0 12                 ,..
        nop                                     ; E751 EA                       .
        nop                                     ; E752 EA                       .
        nop                                     ; E753 EA                       .
        nop                                     ; E754 EA                       .
...
; ----------------------------------------------------------------------------
LE7B5:  jmp     LDE23                           ; E7B5 4C 23 DE                 L#.
...
CMD_SWAP:
        ...
        sta     $B8                             ; EA3E 85 B8                    ..
        .byte   $84                             ; EA40 84                       .
LEA41:  lda     $28A5,y                         ; EA41 B9 A5 28                 ..(
        pha                                     ; EA44 48                       H
        lda     $29                             ; EA45 A5 29                    .)
LEA47:  pha                                     ; EA47 48                       H
...
; ----------------------------------------------------------------------------
        ...
        jmp     SEDORIC_XCHAR                   ; EC2B 4C A3 EB                 L..
...
LF4A8:  lda     #$88                            ; F4A8 A9 88                    ..
        ...
        sta     $05                             ; F4CE 85 05                    ..
        iny                                     ; F4D0 C8                       .
        lda     (L0000),y                       ; F4D1 B1 00                    ..
        sta     $C083                           ; F4D3 8D 83 C0                 ...
        dey                                     ; F4D6 88                       .
        lda     (L0000),y                       ; F4D7 B1 00                    ..
        sta     $0B                             ; F4D9 85 0B                    ..
        rts                                     ; F4DB 60                       `
...
LF785:  ldy     #$13                            ; F785 A0 13                    ..
        lda     (L0000),y                       ; F787 B1 00                    ..
        tax                                     ; F789 AA                       .
        iny                                     ; F78A C8                       .
        lda     (L0000),y                       ; F78B B1 00                    ..
        ldy     #$0C                            ; F78D A0 0C                    ..
...
LF819:  jsr     LDAEE                           ; F819 20 EE DA                  ..
        ...
        ldy     #$13                            ; F825 A0 13                    ..
        lda     (L0000),y                       ; F827 B1 00                    ..
        sta     SEDORIC_TRACK                   ; F829 8D 01 C0                 ...
        iny                                     ; F82C C8                       .
        lda     (L0000),y                       ; F82D B1 00                    ..
...
LF84C:  ldy     #$15                            ; F84C A0 15                    ..
        lda     (L0000),y                       ; F84E B1 00                    ..
        clc                                     ; F850 18                       .
        adc     #$01                            ; F851 69 01                    i.
        sta     (L0000),y                       ; F853 91 00                    ..
        iny                                     ; F855 C8                       .
        lda     (L0000),y                       ; F856 B1 00                    ..
        adc     #$00                            ; F858 69 00                    i.
        sta     (L0000),y                       ; F85A 91 00                    ..
...
LF86A:  inc     $05                             ; F86A E6 05                    ..
        clc                                     ; F86C 18                       .
        ldy     #$02                            ; F86D A0 02                    ..
        lda     (L0000),y                       ; F86F B1 00                    ..
        adc     #$01                            ; F871 69 01                    i.
        sta     (L0000),y                       ; F873 91 00                    ..
        lda     $04                             ; F875 A5 04                    ..
        ldy     $05                             ; F877 A4 05                    ..
...
LF93B:  ldy     #$04                            ; F93B A0 04                    ..
        ...
        ldy     #$13                            ; F949 A0 13                    ..
        lda     (L0000),y                       ; F94B B1 00                    ..
        pha                                     ; F94D 48                       H
        iny                                     ; F94E C8                       .
        lda     (L0000),y                       ; F94F B1 00                    ..
        tay                                     ; F951 A8                       .
        pla                                     ; F952 68                       h
...
; ----------------------------------------------------------------------------
        ...
        jmp     XPMAP                           ; F993 4C 4C DA                 LL.

; ----------------------------------------------------------------------------
        jsr     LE60D                           ; F996 20 0D E6                  ..
        jmp     XSMAP                           ; F999 4C 8A DA                 L..
...
LFA9D:  php                                     ; FA9D 08                       .
        ldy     #$03                            ; FA9E A0 03                    ..
        lda     #$0C                            ; FAA0 A9 0C                    ..
        sta     (L0000),y                       ; FAA2 91 00                    ..
        iny                                     ; FAA4 C8                       .
        lda     #$00                            ; FAA5 A9 00                    ..
        sta     (L0000),y                       ; FAA7 91 00                    ..
        iny                                     ; FAA9 C8                       .
        sta     (L0000),y                       ; FAAA 91 00                    ..
        plp                                     ; FAAC 28                       (
...
LFAD6:  dey                                     ; FAD6 88                       .
        ...
        pla                                     ; FAF7 68                       h
        sta     (L0000),y                       ; FAF8 91 00                    ..
        pla                                     ; FAFA 68                       h
        iny                                     ; FAFB C8                       .
        sta     (L0000),y                       ; FAFC 91 00                    ..
...
LFD0E:  jsr     LF4A8                           ; FD0E 20 A8 F4                  ..
        ldy     #$03                            ; FD11 A0 03                    ..
        lda     (L0000),y                       ; FD13 B1 00                    ..
        sta     $C086                           ; FD15 8D 86 C0                 ...
        iny                                     ; FD18 C8                       .
        lda     (L0000),y                       ; FD19 B1 00                    ..
        sta     $C087                           ; FD1B 8D 87 C0                 ...
        iny                                     ; FD1E C8                       .
        lda     (L0000),y                       ; FD1F B1 00                    ..
...
LFD2A:  jsr     LF4A8                           ; FD2A 20 A8 F4                  ..
        ...
        sta     (L0000),y                       ; FD32 91 00                    ..
        dey                                     ; FD34 88                       .
        lda     $C087                           ; FD35 AD 87 C0                 ...
        sta     (L0000),y                       ; FD38 91 00                    ..
        dey                                     ; FD3A 88                       .
        lda     $C086                           ; FD3B AD 86 C0                 ...
        cmp     (L0000),y                       ; FD3E D1 00                    ..
        sta     (L0000),y                       ; FD40 91 00                    ..
...
LFD46:  sec                                     ; FD46 38                       8
        ...
        ldy     #$04                            ; FD55 A0 04                    ..
        lda     (L0000),y                       ; FD57 B1 00                    ..
        clc                                     ; FD59 18                       .
        adc     $05                             ; FD5A 65 05                    e.
        sta     $05                             ; FD5C 85 05                    ..
        dey                                     ; FD5E 88                       .
        lda     (L0000),y                       ; FD5F B1 00                    ..
        tay                                     ; FD61 A8                       .
        lda     ($04),y                         ; FD62 B1 04                    ..
        pha                                     ; FD64 48                       H
        iny                                     ; FD65 C8                       .
...
LFD7A:  clc                                     ; FD7A 18                       .
        ...
        ldy     #$02                            ; FD86 A0 02                    ..
        lda     (L0000),y                       ; FD88 B1 00                    ..
        ldy     #$04                            ; FD8A A0 04                    ..
        cmp     (L0000),y                       ; FD8C D1 00                    ..
        bne     LFDA4                           ; FD8E D0 14                    ..
        dey                                     ; FD90 88                       .
        lda     (L0000),y                       ; FD91 B1 00                    ..
        tay                                     ; FD93 A8                       .
        iny                                     ; FD94 C8                       .
        iny                                     ; FD95 C8                       .
...
LFDA4:  jsr     LF4A8                           ; FDA4 20 A8 F4                  ..
        ldy     #$03                            ; FDA7 A0 03                    ..
        lda     (L0000),y                       ; FDA9 B1 00                    ..
        clc                                     ; FDAB 18                       .
        adc     #$02                            ; FDAC 69 02                    i.
        bne     LFDBA                           ; FDAE D0 0A                    ..
        ldy     #$04                            ; FDB0 A0 04                    ..
        lda     (L0000),y                       ; FDB2 B1 00                    ..
        adc     #$00                            ; FDB4 69 00                    i.
        sta     (L0000),y                       ; FDB6 91 00                    ..
        lda     #$02                            ; FDB8 A9 02                    ..
LFDBA:  ldy     #$03                            ; FDBA A0 03                    ..
        sta     (L0000),y                       ; FDBC 91 00                    ..
        jsr     LFD44                           ; FDBE 20 44 FD                  D.
        ldy     #$00                            ; FDC1 A0 00                    ..
LFDC3:  tya                                     ; FDC3 98                       .
        ldy     #$05                            ; FDC4 A0 05                    ..
        sta     (L0000),y                       ; FDC6 91 00                    ..
        tay                                     ; FDC8 A8                       .
        lda     ($02),y                         ; FDC9 B1 02                    ..
        rts                                     ; FDCB 60                       `
...
; ----------------------------------------------------------------------------
        jsr     CMD_AZERTY                      ; FEE0 20 07 FE                  ..
        jsr     LFF00                           ; FEE3 20 00 FF                  ..
