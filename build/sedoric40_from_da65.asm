...
START_STRATORIC := $FC00                        ; $FC00
skip2           := $FC4D
init_first_boot := $FC6E                        ; First boot : initialize values for atmos rom
COPY_CODE_TO_B800:= $FCCF                       ; $FCCF
COPY_C000_FROM_ROM_TO_C400_RAM_OVERLAY:= $FCD0  ; $FCD0
str_STRATORIC   := $FD85                        ; $FD86
ADDRESS_0X238_TABLE:= $FDBF                     ; XX
ADDRESS_0X228_TABLE:= $FDD2                     ; XX
READ_KEYBOARD   := $FDDB                        ; $FDDB
FIXME2          := $FDE7                        ; $FDE7
INIT_VIA1       := $FDFC                        ; $FDFC
NMI_VECTOR      := $FFFA
RESET_VECTOR    := $FFFC
